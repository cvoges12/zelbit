...
uint256 hashGenesisBlock("0xd494b733e6351d68a0e53bbebd76655e8941214dd77b516c2d0fd663e52f181c");
...
const string strMessageMagic = "ZelBit Signed Message:\n";
...
static const int64 nTargetTimespan = 3 *24 * 60 * 60; // ZelBit: 3 days
static const int64 nTargetSpacing = 180; // ZelBit: 3 Minutes
static const int64 nInterval = nTargetTimespan / nTargetSpacing;

// Thanks: Balthazar for suggesting the following fix
// https://bitcointalk.org/index.php?topic=182430.msg1904506#msg1904506
static const int64 nReTargetHistoryFact = 3; // look at 3 times the retarget
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal ZelBit miner
    ...
    if (!IsCoinBase())
    {
        ...
        if (nTxFee < 0)
            return DoS(100, error("ConnectInputs() : %s nTxFee < 0", GetHash().ToString().substr(0,0.1).c_str()));
        nFees += nTxFee;
        if (!MoneyRange(nFees))
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ZelBit", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbaa5bcc6567fd8270bd58708c8a6a76e7f4e6f4cce37a7846afd8f3ac17efe4b");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "12 June 2014 21:48 GMT, BBC News - Bank of England hints at possible rate rise this year";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1402791401; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1347693;

        if (fTestNet)
        {
            block.nTime    = 1402612617;
            block.nNonce   = 1357690;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x33465c0f522834c1c227cb24a64dbf99b1210217bd200096fdc9ce0897eea0f7"));
