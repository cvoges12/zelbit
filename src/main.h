...
static const int64 MAX_MONEY = 27000000 * COIN; // maximum number of coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 480 / 250; // 480 blocks found a day. Priority cutoff is 1 ZLB day / 250 bytes.
    }
